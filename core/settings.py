...
MIDDLEWARE = [
    ...
    # custom
    "users.middleware.AnonymousUserTypeMiddleware",
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # custom
                'users.context_preprocessors.set_anonymous_user_type'
            ],
        },
    },
]
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://postgres:iori@localhost:5432/edufund',
        conn_max_age=600
    )
    # 'default': {
...
SPECTACULAR_SETTINGS = {
    "TITLE": "EduFund",
    "DESCRIPTION": "EduFund is a crowdfunding platform that helps financially struggling secondary school students in Nigerian (public) schools raise funds for school fees and essential learning materials.",
    "VERSION": "1.0.0",
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'jonasinfo2016@gmail.com'
# # your email address
# EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER')
# your email password/app password
# EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')
EMAIL_HOST_PASSWORD = 'qnbz skim aqru widx'
